...
sample_indices_info=rmmn/mvmr/samples/$dataset_name\_test_mvmr.json
...
test_net_mvmr.py --config-file $config_file --ckpt $weight_file --sample_indices_info $sample_indices_info --additional_name $additional_name OUTPUT_DIR $weight_dir TEST.BATCH_SIZE $batch_size
