...
_C.MODEL.MMN.TEXT_ENCODER.INPUT_SIZE = 768
...
_C.MODEL.MMN.LOSS.NEGATIVE_WEIGHT = 0.3
...
_C.SOLVER.FREEZE_CLIP = 4
_C.SOLVER.ONLY_IOU = 7
_C.SOLVER.SKIP_TEST = 0
_C.SOLVER.ONLY_POSITIVE = 7
...
_C.MVMR = CN()
_C.MVMR.NUM_SAMPLES = 100
  
# ---------------------------------------------------------------------------- #
# SIMANS
# ---------------------------------------------------------------------------- #
_C.SIMANS = CN()
_C.SIMANS.BATCH_SIZE = 16
_C.SIMANS.PRE_TOPK = 100
_C.SIMANS.TOPK = 50
_C.SIMANS.TAU = 0.5
_C.SIMANS.POS_IOU_THRESH = 0.7
