...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "tacos_val":{
            "video_dir": "./dataset/TACoS/videos",
            "ann_file": "./dataset/TACoS/val.json",#"./dataset/TACoS/train.json",#
            "feat_file": "./dataset/TACoS/tall_c3d_features.hdf5",
        },
        "tacos_test":{
            "video_dir": "./dataset/TACoS/videos",
            "ann_file": "./dataset/TACoS/test.json",#"./dataset/TACoS/train.json",#
            "feat_file": "./dataset/TACoS/tall_c3d_features.hdf5",
        },
        "activitynet_train":{
        ...
        "charades_test": {
            ...
            "ann_file":  "./dataset/Charades_STA/charades_test.json", #"./dataset/Charades_STA/charades_train.json",#
            "feat_file": "./dataset/Charades_STA/vgg_rgb_features.hdf5",
        },
    }
