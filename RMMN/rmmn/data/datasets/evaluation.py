...
import logging
import torch
from rmmn.data.datasets.utils import iou, score2d_to_moments_scores
from rmmn.utils.comm import is_main_process
...
def evaluate(cfg, dataset, predictions, nms_thresh, recall_metrics=(1, 5)):
    ...
    for idx, result2d in enumerate(predictions):   # each video
